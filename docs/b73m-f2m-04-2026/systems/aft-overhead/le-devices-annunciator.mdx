...
<ManualHeader manual={"FCOM"} serial={"B73M/F2M/04/2026"} issue={1} revision={1} chapter={"Systems description"} section={"LE Devices Annunciator Panel"} effective={"2026-08-27"} />
...
<ManualFooter serial={"B73M/F2M/04/2026"} issue={1} revision={1} sectionId={"le-devices-annunciator"} client={"TFC European Airline Services GmbH"} />
