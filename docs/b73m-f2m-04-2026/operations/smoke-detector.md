...
TODO(łukasz): a photograph of the unit and its position on the IOS ceiling is required for this section. The build does not copy `components/smoke-detector/assets/` into the site yet, so no image is referenced here.
