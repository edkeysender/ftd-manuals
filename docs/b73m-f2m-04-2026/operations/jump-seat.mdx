...
<ManualHeader manual={"FCOM"} serial={"B73M/F2M/04/2026"} issue={1} revision={1} chapter={"FNPT operations"} section={"Jump Seat"} effective={"2026-08-27"} />

:::info[Effectivity]
Component **`jump-seat`** · installed software **1.0.0** · documented range `>=1.0.0 <2.0.0` · chunk revision `58588f8` (2026-08-28)
:::
...
seat is fitted to every serial number — `module.yaml` currently carries a placeholder location.


<ManualFooter serial={"B73M/F2M/04/2026"} issue={1} revision={1} sectionId={"jump-seat"} client={"TFC European Airline Services GmbH"} />
