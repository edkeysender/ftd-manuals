...
<ManualHeader manual={"FCOM"} serial={"B73M/F2M/05/2026"} issue={1} revision={0} chapter={"Systems description"} section={"LE Devices Annunciator Panel"} effective={""} />
...
<ManualFooter serial={"B73M/F2M/05/2026"} issue={1} revision={0} sectionId={"le-devices-annunciator"} client={"TODO(łukasz): operator name for this device"} />
