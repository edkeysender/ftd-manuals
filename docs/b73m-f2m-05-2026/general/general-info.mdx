...
<ManualHeader manual={"FCOM"} serial={"B73M/F2M/05/2026"} issue={1} revision={0} chapter={"General"} section={"General information"} effective={""} />
...
<ManualFooter serial={"B73M/F2M/05/2026"} issue={1} revision={0} sectionId={"general-info"} client={"TODO(łukasz): operator name for this device"} />
